...
ax1.legend(['train', 'test'], loc=(0.8, 0.05))
subax1 = add_subplot_axes(ax1, subpos + [0, 0.4, 0, 0])
subax1.set_ylim([99, 100])
subax1.set_yticks([99, 100])
subax1.plot(data['train']['regular']['dnn_score']['steps'][-21:], [v * 100 for v in data['train']['regular']['dnn_score']['values'][-21:]], 'k')
subax1.plot(data['test']['regular']['dnn_score']['steps'][-21:] , [v * 100 for v in data['test']['regular']['dnn_score']['values'][-21:]] , 'k--')
ax1.add_patch(patches.Polygon(xy=np.array([[800, 95], [530, 84], [975, 46], [1000, 95]]), closed=True, color='silver'))
...
subax3.plot(data['test']['regular']['knn_kl_div2_avg']['steps'][-21:], [v * 100 for v in data['test']['regular']['knn_kl_div2_avg']['values'][-21:]], 'r')
subax3.plot(data['test']['regular']['svm_kl_div2_avg']['steps'][-21:], [v * 100 for v in data['test']['regular']['svm_kl_div2_avg']['values'][-21:]], 'b')
subax3.plot(data['test']['regular']['lr_kl_div2_avg']['steps'][-21:] , [v * 100 for v in data['test']['regular']['lr_kl_div2_avg']['values'][-21:]] , 'g')
...
subax5 = add_subplot_axes(ax5, subpos + [0.2, 0, 0, 0])
...
ax5.add_patch(patches.Polygon(xy=np.array([[40000, 7], [26500, 20], [48000, 47], [50000, 7]]), closed=True, color='silver'))
...
subax6 = add_subplot_axes(ax6, subpos - [-0.2, 0.21, 0, 0])
...
ax6.add_patch(patches.Polygon(xy=np.array([[40000, 7], [26500, 21], [48000, 47], [50000, 7]]), closed=True, color='silver'))
