...
ax1.add_patch(patches.Polygon(xy=np.array([[4.75, 102.3], [4.17, 83.4], [5.1, 83.4], [5.1, 39.2], [5.25, 92.7]]), closed=True, color='silver'))
...
ax3.add_patch(patches.Polygon(xy=np.array([[4.75, 55.1], [4.17, 38.4], [5.1, 38.4], [5.1, 12.7], [5.25, 49.5]]), closed=True, color='silver'))
...
ax3.legend(['K=1', 'K=5', 'K=30', 'K=100', 'DNN'], loc=(0.59, 2.2))
