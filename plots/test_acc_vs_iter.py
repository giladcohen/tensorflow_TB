...
ax6.plot(data['test']['regular']['dnn_score']['steps'], [v * 100 for v in data['test']['regular']['dnn_score']['values']], 'b')
ax6.plot(data['test']['regular']['knn_score']['steps'], [v * 100 for v in data['test']['regular']['knn_score']['values']], 'r')
ax6.plot(data['test']['regular']['svm_score']['steps'], [v * 100 for v in data['test']['regular']['svm_score']['values']], 'k')
...
ax1.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax2.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax3.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax4.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax5.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax6.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax7.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax8.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
ax9.legend(['DNN', '$k$-NN', 'SVM', 'Logistic\nregression'], loc=(0.6, 0.1))
