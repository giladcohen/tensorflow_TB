...
ax3.plot(1000, 67.34, 'ro')
# ax3.plot(data['train']['regular']['dnn_score']['steps'], [v * 100 for v in data['train']['regular']['dnn_score']['values']], 'k')
...
ax5.plot(3200, 29.85, 'ro')
# ax5.plot(data['train']['regular']['dnn_score']['steps'][:74], [v * 100 for v in data['train']['regular']['dnn_score']['values'][0:74]], 'k')
