...
ax1.legend(['train', 'test'], loc=(0.01, 0.71), prop={'size': 16})
...
for item in ax2.get_yticklabels():
    item.set_fontsize(13)
ax2.legend(['train', 'test'], loc=(0.01, 0.71), prop={'size': 16})
...
for item in ax3.get_yticklabels():
    item.set_fontsize(13)
ax3.set_title('Random Labeled CIFAR-10')
...
ax4.set_xticklabels(['0', '5', '10', '15', '20'], fontdict={'fontsize': 13})
...
for item in ax5.get_yticklabels():
    item.set_fontsize(13)
ax5.set_title('Random Labeled CIFAR-100')
...
ax6.set_xticklabels(['0', '5', '10', '15', '20'], fontdict={'fontsize': 13})
...
plt.savefig('ma_md_scores_trainset_vs_iter.png', dpi=350)
