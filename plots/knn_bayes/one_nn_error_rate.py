...
measure = 'knn_k_3_norm_L1_knn_score'
...
ax1.yaxis.grid()
ax1.set_ylabel('3-NN error rate', labelpad=5, fontdict={'fontsize': 12})
ax1.set_xlabel('number of samples')
ax1.set_title('KNN error rate (K=3)')

plt.tight_layout()
plt.savefig('three_nn_error_rate.png')