...
ax1.text(-2.7, 60, 'CIFAR-10', va='center', rotation='vertical', fontdict={'fontsize': 13})
...
ax2.text(-2.7, 60, 'Random CIFAR-10', va='center', rotation='vertical', fontdict={'fontsize': 13})
...
ax3.text(-2.7, 60, 'CIFAR-100', va='center', rotation='vertical', fontdict={'fontsize': 13})
...
ax4.text(-2.7, 60, 'Random CIFAR-100', va='center', rotation='vertical', fontdict={'fontsize': 13})
