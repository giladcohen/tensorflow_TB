...
csv_file = '/data/gilad/logs/ma_scores/wrn/mnist/log_0746_020518_ma_score_wrn_mnist_wd_0.00078_steps_1000-SUPERSEED=21031802/data_for_figures/test___knn_score'
steps, values = load_data_from_csv_wrapper(csv_file)
ax1 = fig.add_subplot(331)
ax1.plot(steps, values, 'r')
subax1 = add_subplot_axes(ax1, subpos)
subax1.set_ylim([99.3, 99.6])
subax1.set_yticks([99.3, 99.6])
subax1.plot(steps[-21:], values[-21:], 'r')
...
csv_file = '/data/gilad/logs/ma_scores/wrn/mnist/log_0746_020518_ma_score_wrn_mnist_wd_0.00078_steps_1000-SUPERSEED=21031802/data_for_figures/test___score'
steps, values = load_data_from_csv_wrapper(csv_file)
ax1.plot(steps, values, 'black')
subax1.plot(steps[-21:], values[-21:], 'black')
ax1.set_ylim(bottom=0, top=110)
ax1.set_title('MNIST')
ax1.text(-360, 52, 'Wide ResNet 28-10', va='center', rotation='vertical', fontdict={'fontsize': 13})
ax1.yaxis.grid()
ax1.set_ylabel('accuracy (%)', labelpad=0.5, fontdict={'fontsize': 12})
ax1.add_patch(patches.Polygon(xy=np.array([[800, 104], [556, 66.2], [1000, 66.2], [1000, 32.2], [1000, 94.2]]), closed=True, color='silver'))
...
csv_file = '/data/gilad/logs/ma_scores/lenet/mnist/log_0746_020518_ma_score_lenet_mnist_wd_0.0_steps_1000-SUPERSEED=10031800/data_for_figures/test___knn_score'
steps, values = load_data_from_csv_wrapper(csv_file)
...
subax4.plot(steps[-21:], values[-21:], 'r')
...
csv_file = '/data/gilad/logs/ma_scores/lenet/mnist/log_0746_020518_ma_score_lenet_mnist_wd_0.0_steps_1000-SUPERSEED=10031800/data_for_figures/test___score'
steps, values = load_data_from_csv_wrapper(csv_file)
ax4.plot(steps, values, 'black')
subax4.plot(steps[-21:], values[-21:], 'black')
ax4.set_ylim(bottom=0, top=110)
ax4.text(-360, 52, 'LeNet', va='center', rotation='vertical', fontdict={'fontsize': 13})
ax4.yaxis.grid()
ax4.set_ylabel('accuracy (%)', labelpad=0.5, fontdict={'fontsize': 12})
ax4.add_patch(patches.Polygon(xy=np.array([[800, 103.5], [556, 65.9], [1000, 65.9], [1000, 33.75], [1000, 94.5]]), closed=True, color='silver'))
ax4.add_patch(patches.Rectangle(xy=(800, 94), width=200, height=10, facecolor='moccasin'))
...
csv_file = '/data/gilad/logs/ma_scores/fc2net/mnist/log_0746_020518_ma_score_fc2net_mnist_wd_0.0_steps_1000-SUPERSEED=10031800/data_for_figures/test___knn_score'
steps, values = load_data_from_csv_wrapper(csv_file)
...
csv_file = '/data/gilad/logs/ma_scores/fc2net/mnist/log_0746_020518_ma_score_fc2net_mnist_wd_0.0_steps_1000-SUPERSEED=10031800/data_for_figures/test___score'
steps, values = load_data_from_csv_wrapper(csv_file)
ax7.plot(steps, values, 'black')
ax7.set_ylim(bottom=0, top=110)
ax7.text(-360, 52, 'MLP-640', va='center', rotation='vertical', fontdict={'fontsize': 13})
ax7.yaxis.grid()
