    ...
    def after_run(self, run_context, run_values):
        ...
        if epoch < 60:
            ...
            if not self._notify[0]:
                self._logger.info('epoch={}. Decreasing learning rate to {}'.format(epoch, self._lrn_rate))
                self._notify[0] = True
        elif epoch < 120:
