"""
This trainer is like KMeansSegmentsKnnDnnCorrelationTrainer except that we use the dynamic model.
"""
...
class KMeansSegmentsKnnDnnCorrelationDynamicTrainer(DynamicModelTrainer):
