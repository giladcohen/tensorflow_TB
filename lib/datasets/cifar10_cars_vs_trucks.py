    ...
    def get_raw_data(self, dataset_name):
        ...
        for i, label in enumerate(y_train):
            if label == 1:
                ...
                err_str = 'y_train[{}] equals {} instead of 1 or 9'.format(i, label)
